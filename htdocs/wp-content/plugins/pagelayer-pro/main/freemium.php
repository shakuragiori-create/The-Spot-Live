...
pagelayer_freemium_shortcode(PAGELAYER_SC_PREFIX.'_flipbox', array(
				...
				<div class="pagelayer-flipbox-flipper">
						...
						<div class="pagelayer-flipbox-box-overlay">
							<div class="pagelayer-flipbox-box-inner">
								<div class="pagelayer-flipbox-content">
									...
									<h2 class="pagelayer-flipbox-front-heading" if={{front_heading}}>{{front_heading}}</h2>
									<p class="pagelayer-flipbox-front-content" if={{front_content}}>{{front_content}}</p>
								</div>
							</div>
						</div>
					</div>
					<div class="pagelayer-flipbox-box pagelayer-flipbox-back" style="">
						<div class="pagelayer-flipbox-box-overlay">
							<div class="pagelayer-flipbox-box-inner">
								<div class="pagelayer-flipbox-content">
									<h2 class="pagelayer-flipbox-back-heading" if={{back_heading}}>{{back_heading}}</h2>
									<p class="pagelayer-flipbox-back-content" if={{back_content}}>{{back_content}}</p>
		...
		'front_section' => array(
			...
			'front_heading' => array(
				...
				'np' => 1,
				'edit' => '.pagelayer-flipbox-front-heading',
			),
			'heading_color' => array(
				'type' => 'color',
				'label' => __pl('color'),
			...
			'front_content' => array(
				...
				'edit' => '.pagelayer-flipbox-front-content',
			),
		...
		'back_section' => array(
			...
			'back_heading' => array(
				...
				'edit' => '.pagelayer-flipbox-back-heading',
			),
			...
			'back_content' => array(
				...
				'np' => 1,
				'default' => 'Flipbox content comes here such as It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.',
				'edit' => '.pagelayer-flipbox-back-content',
			),
