...
pagelayer_add_shortcode(PAGELAYER_SC_PREFIX.'_img_portfolio', array(
	...
	'img_style' =>[
		...
		'img_border_radius' => array(
			...
			'label' => __pl('border_radius'),
			'screen' => 1,
			'css' => ['{{element}} .pagelayer-pf-img img' => 'border-radius: {{val[0]}}px {{val[1]}}px {{val[2]}}px {{val[3]}}px; -webkit-border-radius:  {{val[0]}}px {{val[1]}}px {{val[2]}}px {{val[3]}}px;-moz-border-radius: {{val[0]}}px {{val[1]}}px {{val[2]}}px {{val[3]}}px;'],
		),
		'img_hover' => array(
			'type' => 'radio',
			'label' => __pl('state'),
