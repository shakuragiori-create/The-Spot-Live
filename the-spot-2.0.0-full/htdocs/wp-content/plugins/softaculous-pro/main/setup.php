			...
			<?php foreach(spro_get_features_list() as $slug => $feature):?>
				<label for="<?php echo $slug;?>_input" style="cursor:pointer;">
					...
					<div class="softaculous-pro-features-text">
						<?php
						$is_new = !empty($feature['new']) && time() < $feature['new'];
						?>
						<h3><?php echo $feature['name']; ?><?php if($is_new){ echo ' <span class="softaculous-pro-new-tag">'.__('New', 'softaculous-pro').'</span>'; } ?></h3>
