...
function spro_get_features_list(){
	...
	$features_list = array(
		...
		"formlayer" => array(
			"name" => __('FormLayer', 'softaculous-pro'),
			"info" => __("Create powerful contact forms for your website", "softaculous-pro"),
			"icon" => 'dashicons dashicons-feedback',
			"plugin"=> array(
				"formlayer" => array(
					'plugin_name' => __('FormLayer – Easy Form Builder for WordPress', 'softaculous-pro'),
					'plugin_url'=> 'https://formlayer.net/',
					'plugin_init' => 'formlayer/formlayer.php',
					'plugin_init_pro' => 'formlayer-pro/formlayer-pro.php',
					'plugin_download_url_pro' => softaculous_pro_api_url(0, 'formlayer').'download.php',
					'plugin_desc' => __('FormLayer helps you create powerful forms for your WordPress website, including contact forms, feedback forms, surveys, and more with advanced features and seamless integrations.', 'softaculous-pro'),
					'pro' => 1,
					'featured' => 1,
					'requires_php' => 7.0,
					),
				),
			'new' => strtotime('30 June 2026'),
		),
